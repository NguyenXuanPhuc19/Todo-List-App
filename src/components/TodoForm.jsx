...
const TodoForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
        <label htmlFor="todoInput" className="hidden">Create a new todo</label>
        <input
        type="text"
        className="p-4 pl-12 mt-4 w-full focus:outline-1 focus:outline-purple-400 bg-white placeholder:text-gray-400 border rounded-lg"
