...
import { editTodo, markTodoCompleted, removeTodo } from '../slice/todoSlice';
...
const TodoItem = ({ todo }) => {
    ...
    return (
        <div
          className=" border-b border-gray-100 dark:border-slate-500 py-4 flex justify-between items-center cursor-pointer"
          id="hello"
        >
